...
```
- Search for `def __init__ (self,addr=0x60,freq=1600,i2c=none,i2c_bus=none)`
- Change to `def __init__ (self,addr=0x40,freq=1600,i2c=none,i2c_bus=none)` and click save.
